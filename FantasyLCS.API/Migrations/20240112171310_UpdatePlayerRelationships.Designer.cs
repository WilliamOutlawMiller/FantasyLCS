...
namespace FantasyLCS.API.Migrations
{
    ...
    [Migration("20240112171310_UpdatePlayerRelationships")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FullStats", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("PlayerStats.AggressionStats", b =>
                {
                    b.Property<int>("PlayerID")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("PlayerStats.ChampionStats", b =>
                {
            ...
            modelBuilder.Entity("PlayerStats.EarlyGameStats", b =>
                {
                    b.Property<int>("PlayerID")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("PlayerStats.GeneralStats", b =>
                {
                    b.Property<int>("PlayerID")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("PlayerStats.VisionStats", b =>
                {
                    b.Property<int>("PlayerID")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("PlayerStats.AggressionStats", b =>
                {
                    b.HasOne("FantasyLCS.DataObjects.Player", "Player")
                        ...
                        .HasForeignKey("PlayerStats.AggressionStats", "PlayerID")
            ...
            modelBuilder.Entity("PlayerStats.EarlyGameStats", b =>
                {
                    b.HasOne("FantasyLCS.DataObjects.Player", "Player")
                        ...
                        .HasForeignKey("PlayerStats.EarlyGameStats", "PlayerID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PlayerStats.GeneralStats", b =>
                {
                    b.HasOne("FantasyLCS.DataObjects.Player", "Player")
                        ...
                        .HasForeignKey("PlayerStats.GeneralStats", "PlayerID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PlayerStats.VisionStats", b =>
                {
                    b.HasOne("FantasyLCS.DataObjects.Player", "Player")
                        .WithOne("VisionStats")
                        .HasForeignKey("PlayerStats.VisionStats", "PlayerID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
