...
namespace FantasyLCS.API.Migrations
{
    ...
    [Migration("20240315191847_AddFinalScoreToLeagueMatch")]
    partial class AddFinalScoreToLeagueMatch
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("League", b =>
                {
                    ...
                    b.Property<int>("LeagueStatus")
                        .HasColumnType("INTEGER")
                        .HasAnnotation("Relational:JsonPropertyName", "leagueStatus");
            ...
            modelBuilder.Entity("LeagueMatch", b =>
                {
                    ...
                    b.Property<double>("TeamOneFinalScore")
                        .HasColumnType("REAL")
                        .HasAnnotation("Relational:JsonPropertyName", "teamOneFinalScore");

                    b.Property<int>("TeamOneID")
                        .HasColumnType("INTEGER")
                        .HasAnnotation("Relational:JsonPropertyName", "teamOneID");

                    b.Property<double>("TeamTwoFinalScore")
                        .HasColumnType("REAL")
                        .HasAnnotation("Relational:JsonPropertyName", "teamTwoFinalScore");

                    b.Property<int>("TeamTwoID")
                        .HasColumnType("INTEGER")
                        .HasAnnotation("Relational:JsonPropertyName", "teamTwoID");
